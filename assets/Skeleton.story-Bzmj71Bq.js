import{r as c,j as e}from"./iframe-71Dfa6A1.js";import{m as l}from"./merge-0FHwH-zM.js";import"./preload-helper-D9Z9MdNV.js";function s({className:n,...o}){const t=c.useMemo(()=>l("inline-block animate-pulse rounded-md bg-accent",n),[n]);return e.jsx("span",{className:t,...o})}s.__docgenInfo={description:"",methods:[],displayName:"Skeleton"};const i={title:"elements/Skeleton",component:s,tags:["autodocs"],argTypes:{}},a={render:()=>e.jsxs("div",{className:"flex items-center space-x-4",children:[e.jsx(s,{className:"h-12 w-12 rounded-full"}),e.jsxs("div",{className:"flex flex-col space-y-2",children:[e.jsx(s,{className:"h-4 w-[250px]"}),e.jsx(s,{className:"h-4 w-[200px]"})]})]})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
