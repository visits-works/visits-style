...
function setColor(_ref) {
  ...
  var subColor = addonColor ? getColor(theme, addonColor) : (0, _polished.darken)(0.05, target);
  return (0, _styledComponents.css)(["color:", ";background-color:", ";a,span{color:", ";background-color:", ";}a:hover{background-color:", ";}"], invertColor, target, invertColor, subColor, (0, _polished.darken)(0.05, subColor));
}
  ...
  _createClass(Tag, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Wrapper, _extends({
        close: onClose !== null
      }, rest), children, onClose && _react.default.createElement("a", {
        tabIndex: 0,
        role: "link",
        onClick: onClose
      }, "\xA0"));
