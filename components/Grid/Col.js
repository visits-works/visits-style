...
function renderSize({
  ...
  if (!size || size < 1 || size > 12) {
    ...
    return css(["flex:none;width:", "%;", " ", ""], value, offset ? `margin-left: ${offVal}%;` : '', auto ? mediaMobile`
...
})(["display:block;min-height:1px;max-width:100%;", " ", " ", " padding:0.75rem;", ""], ({
  narrow
}) => narrow ? 'flex: none;' : '', ({
  offset
}) => offset ? `margin-left: ${parcentage(offset)}%;` : '', renderSize, mediaMobile`
    padding: 0.5rem;
  `);
Col.displayName = 'Col';
export default Col;