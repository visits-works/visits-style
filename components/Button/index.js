...
function setColor(_ref) {
  ...
  if (!color) {
    ...
    return (0, _styledComponents.css)(["background-color:transparent;border-color:transparent;color:", ";&:hover{text-decoration:underline;}"], theme.text);
  }
  ...
  if (outline) {
    return (0, _styledComponents.css)(["background-color:transparent;border-color:", ";color:", ";&:hover{background-color:", ";color:", ";}&:focus{", "}"], target, target, target, invertColor, (0, _boxShadow.default)('0.2rem', target));
  }

  return (0, _styledComponents.css)(["background-color:", ";border-color:", ";border-color:transparent;color:", ";box-shadow:none;&:hover{background-color:", ";}&:active{background-color:", ";}&:focus{", "}"], target, target, invertColor, (0, _darken.default)(0.025, target), (0, _darken.default)(0.05, target), (0, _boxShadow.default)('0.2rem', target));
}
