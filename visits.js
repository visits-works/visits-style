...
function (_PureComponent) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      }, rest), children, React.createElement(TooltipWrapper, {
        ref: this.tooltip,
        show: show,
        role: "tooltip",
        style: style
