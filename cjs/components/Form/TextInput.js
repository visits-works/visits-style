...
var TextInput = /** @class */ (function (_super) {
    ...
    TextInput.prototype.render = function () {
        var _a = this.props, className = _a.className, outline = _a.outline, error = _a.error, help = _a.help, leftIcon = _a.leftIcon, rightIcon = _a.rightIcon, style = _a.style, rest = __rest(_a, ["className", "outline", "error", "help", "leftIcon", "rightIcon", "style"]);
        return (react_1.default.createElement(Wrapper, { className: className, outline: outline, error: error, style: style },
