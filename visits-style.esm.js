...
function Field(_ref3) {
  ...
  return React.createElement(Wrapper, Object.assign({}, rest), label && React.createElement(Label, {
    htmlFor: htmlFor
  }, label, required && React.createElement("i", null, "*")), children);
}
...
function HelpMessage(_ref2) {
  ...
  if (help) return React.createElement(Message, null, help);
  return null;
}
...
function TextInput(_ref) {
  ...
  return React.createElement(Wrapper$1, {
    ...
    right: true
  }, rightIcon), React.createElement("input", Object.assign({
    type: type,
    maxLength: maxLength
  }, rest)), React.createElement(HelpMessage, {
    help: help,
    error: error
  }));
}
...
setSize('font-size'), function (_ref7) {
  ...
  var disabled = _ref12.disabled,
      theme = _ref12.theme;
  return disabled ? css(["input{", " border-style:dashed;}"], disabledColor(theme)) : undefined;
});
...
function Textarea(_ref) {
  ...
  return React.createElement(Wrapper$2, {
    ...
    style: style,
    disabled: rest.disabled
  }, React.createElement("textarea", Object.assign({}, rest)), React.createElement(HelpMessage, {
    help: help,
    error: error
  }));
}
...
setSize('font-size'), function (_ref4) {
  ...
  var disabled = _ref9.disabled,
      theme = _ref9.theme;
  return disabled ? css(["textarea{", " border-style:dashed;}"], disabledColor(theme)) : undefined;
});
...
function Checkbox(_ref) {
  ...
  var innerClass = useMemo(function () {
    var arr = [];
  ...
  }, React.createElement(Approved, null)), children));
}
var Shape =
/*#__PURE__*/
styled.div.withConfig({
...
function Select(_ref) {
  ...
  var list = useMemo(function () {
    return options.map(function (item) {
      return typeof item === 'string' ? React.createElement("option", {
        key: item,
        value: item
      }, render ? render(item) : item) : React.createElement("option", {
        key: item.id,
        value: item.id
  ...
  return React.createElement(InputWrapper, {
    ...
    error: !!error,
    disabled: rest.disabled
  }, React.createElement("select", Object.assign({}, rest), placeholder && React.createElement("option", {
    value: "",
    disabled: !optional
  }, placeholder), list), React.createElement(ChevronDown, null), React.createElement(HelpMessage, {
    help: help,
    error: error
  }));
}
...
styled.span.withConfig({
  ...
  var outline = _ref5.outline,
      theme = _ref5.theme;
  return outline ? css(["border-radius:", ";"], theme.radius) : css(["border-width:0;border-radius:0;border-bottom-width:1px;"]);
}, function (_ref6) {
  var theme = _ref6.theme;
  return theme.borderHover;
}, function (_ref7) {
  ...
  var disabled = _ref12.disabled,
      theme = _ref12.theme;
  return disabled ? css(["select{", " border-style:dashed;}svg{display:none;}"], disabledColor(theme)) : undefined;
});
...
function Radio(_ref) {
  ...
  return React.createElement(Wrapper$4, {
    ...
    htmlFor: id
  }, React.createElement(Shape$1, {
    className: innerClass
  }, React.createElement("i", null)), children), React.createElement("input", Object.assign({
    id: id,
    type: "radio"
  }, rest)));
}
...
function Switch(_ref) {
  ...
  var id = useRef("switch_".concat(rest.name));
...
var labelStyle =
/*#__PURE__*/
css(["label:before{position:absolute;display:block;content:'OFF';top:0.45rem;right:0.6875rem;font-size:0.75rem;color:", ";}input:checked ~ label:before{content:'ON';right:unset;left:0.6875rem;color:", ";}"], function (_ref2) {
  var theme = _ref2.theme;
...
styled.span.withConfig({
  ...
  var disabled = _ref9.disabled,
      theme = _ref9.theme;
  return disabled ? css(["cursor:default;label{", " &:after{background:", ";}}input:checked ~ label{background:", ";}"], disabledColor(theme), theme.disabled, theme.grey) : undefined;
});
...
function Accordion(_ref) {
  ...
  return React.createElement("div", Object.assign({}, rest), header, React.createElement(Transition, {
    timeout: timeout,
    "in": show,
    unmountOnExit: true
  }, function (state) {
    return React.createElement(AnimatedContent, {
      className: state,
      timeout: timeout
    }, children);
  }));
...
function AppBar(_ref) {
  ...
  return React.createElement(NavBar, Object.assign({
    role: "navigation"
  }, rest), React.createElement("nav", null, brand, children && React.createElement(Burger, {
...
function setResponsive(_ref) {
  ...
  return css(["margin-right:auto;margin-left:auto;"]);
}
...
function Hero(_ref4) {
  ...
  return React.createElement(Wrapper$6, Object.assign({
    color: color,
    size: size
...
function Tooltip(_ref) {
  ...
  return React.createElement(Wrapper$7, Object.assign({
    ref: parent,
...
function Popover(_ref) {
  ...
  return React.createElement(Wrapper$8, {
    ...
    ref: parent,
    onClick: handleFocus
  }, label, React.createElement(Tooltip$1, Object.assign({
    show: show,
    role: "tooltip",
    ref: tooltip,
    style: tooltipStyle,
    color: color
  }, rest), children), show && React.createElement(Shadow, {
    onClick: handleBlur
  }));
}
var Wrapper$8 =
...
function Modal(_ref2) {
  ...
  return React.createElement(Transition, {
    ...
    return React.createElement(Wrapper$9, {
      role: "dialog",
      "aria-modal": "true",
      className: className
    }, React.createElement(Shadow$1, {
...
function ToastItem(_ref2) {
  ...
  return React.createElement(Transition, {
    ...
    return React.createElement(Wrapper$a, Object.assign({
      className: state,
      borderless: true,
      color: color,
      clear: clearOnClick
    }, rest), message, clearOnClick && React.createElement(ClearButton, {
      onClick: onClear
...
function Toast(_ref3) {
  ...
  //   };
  return React.createElement(Container$1, Object.assign({}, rest, {
    margin: margin,
    style: _objectSpread({
      position: fixed ? 'fixed' : 'absolute'
    }, style)
  }), toasts.map(function (props) {
    return React.createElement(ToastItem, Object.assign({}, props, {
      key: props.id,
      clear: clear
    }));
  }));
...
function setAutoSize(_ref) {
  ...
  return css(["", "{flex-basis:", ";max-width:", ";}", "{flex-basis:", ";max-width:", ";}"], mediaDesktop, desktopSize, desktopSize, mediaMobile, mobileSize, mobileSize);
}
...
var setAnimation = function setAnimation(_ref) {
  var theme = _ref.theme;
  return keyframes(["0%{background-color:", ";}50%{background-color:", ";}100%{background-color:", ";}"], theme.greyLighter, theme.grey, theme.greyLighter);
};
...
function setColor$2(_ref) {
  ...
  if (!color) {
    return css(["border-color:", ";color:", ";&:hover{border-color:", ";}&:active{border-color:", ";}"], theme.border, theme.text, theme.borderHover, theme.borderActive);
  }
  ...
  if (outline) {
    return css(["background-color:transparent;border-color:", ";color:", ";&:hover{background-color:", ";color:", ";}&:active{background-color:", ";}&:focus:not(:active){", "}"], target, target, target, invertColor, darken(0.1, target), boxShadow('0.1rem', target, 0.5));
  }

  return css(["background-color:", ";border-color:transparent;color:", ";box-shadow:none;&:hover{color:", ";background-color:", ";}&:active{background-color:", ";}&:focus:not(:active){", "}"], target, invertColor, invertColor, darken(0.05, target), darken(0.1, target), boxShadow('0.1rem', target, 0.5));
}
...
styled.button.withConfig({
  ...
  return pure ? undefined : {
    background: transparentize(0.9, theme[color] || theme.text)
  };
}, function (_ref7) {
  var pure = _ref7.pure,
      theme = _ref7.theme,
      color = _ref7.color;
  return pure ? undefined : {
    background: transparentize(0.8, theme[color] || theme.text)
  };
}, function (_ref8) {
  var disabled = _ref8.disabled,
      theme = _ref8.theme;
  return disabled ? css(["color:", ";cursor:default;&:hover{background:transparent;text-decoration:none;}"], transparentize(0.75, theme.textDark)) : undefined;
});
...
styled.table.withConfig({
  ...
  var full = _ref.full;
  return full ? css(["width:100%;"]) : undefined;
}, function (_ref2) {
  var theme = _ref2.theme,
      bordered = _ref2.bordered;
  return bordered ? css(["border:1px solid ", ";"], theme.border) : undefined;
}, function (_ref3) {
  ...
  return headerStyle ? css(["th{", "}"], headerStyle) : undefined;
});
...
function Progress(_ref) {
  ...
  return React.createElement(Wrapper$b, Object.assign({
    color: color
...
var closeCss =
/*#__PURE__*/
css(["padding-right:0;", "{color:inherit;height:100%;margin-left:0.25rem;svg{width:50%;height:50%;}&:hover{background-color:rgba(0,0,0,0.15);}}"], TextButton);
var Wrapper$c =
/*#__PURE__*/
styled.div.withConfig({
  ...
  var invertColor = findColorInvert(theme, target);
  var subColor = addonColor ? getColor$1(theme, addonColor) : darken(0.05, target);
...
function Tag(_ref6) {
  ...
  return React.createElement(Wrapper$c, Object.assign({
    close: !!onClose
  }, rest), children, onClose && React.createElement(TextButton, {
    onClick: onClose,
    pure: true
  }, React.createElement(Close, null)));
}
...
export { Accordion, AppBar, Box, Button, ButtonGroup, Card, Checkbox, Col, Container, index as Content, index$3 as Divider, Field, Hero, Approved$1 as IconApproved, ChevronDown as IconArrowDown, ChevronLeftRound as IconChevronLeftRound, ChevronRightRound as IconChevronRightRound, Close as IconClose, FileRound as IconFileRound, Pencil as IconPencil, PencilSimple as IconPencilSimple, Plus as IconPlus, Refresh as IconRefresh, User as IconUser, Modal, index$1 as Placeholder, Popover, Progress, Radio, Row, Select, Spinner, Switch, index$2 as Table, Tag, TextButton, TextInput, Textarea, Toast, Tooltip, Arrow as arrow, boxShadow, theme as defaultTheme, findColorInvert, hamburger as hambuger, mediaDesktop, mediaFullHD, mediaMobile, mediaTablet, mediaUntilFullHD, normalized as normalizeStyle, setSize };
//# sourceMappingURL=visits-style.esm.js.map
