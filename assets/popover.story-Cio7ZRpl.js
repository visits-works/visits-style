import{j as e,r as s}from"./iframe-BB4tf_El.js";import{P as o}from"./index-ZjmowS_y.js";import{T as f}from"./index-j6XuBxkH.js";import{B as l}from"./index-Dn7cIdJ8.js";import{I as w}from"./index-DDCwA6JE.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CFrW7r58.js";import"./index-CrPQbQVo.js";import"./index-CDqGLqrx.js";import"./useIsomorphicLayoutEffect-CUC6N05y.js";import"./stopPropagation-CdkcreiB.js";import"./Base-CHxFwfQ2.js";import"./merge-DApEyPFe.js";const y=["auto","top","left","right","bottom","top-start","top-end","bottom-start","bottom-end"];function k(){}const Y={title:"components/Popover",component:o,tags:["autodocs"],argTypes:{label:{control:!1},children:{control:!1},offset:{defaultValue:{x:0,y:6}}},parameters:{control:{position:y}}},i=e.jsx(l,{variant:"outline",type:"button",children:"show"}),p={render:t=>e.jsx("div",{style:{textAlign:"center"},children:e.jsxs(o,{...t,label:i,children:[e.jsx(l,{type:"button",onClick:()=>{alert("world!")},children:"hello"}),e.jsx("p",{children:"hello world"})]})})},d={name:"auto placement on scroll",render:t=>e.jsxs(e.Fragment,{children:[e.jsx("div",{style:{width:"50px",height:"80vh"}}),e.jsx("div",{style:{textAlign:"center"},children:e.jsxs(o,{...t,style:{padding:50},label:i,children:[e.jsx("button",{type:"button",onClick:()=>{alert("world!")},children:"hello"}),e.jsx("p",{children:"hello world"})]})}),e.jsx("div",{style:{width:"50px",height:"80vh"}})]})},u={render:t=>{const[r,n]=s.useState(""),c=j=>n(j.target.value);return e.jsx(o,{...t,label:i,children:e.jsx(w,{value:r,onChange:c})})}},h={name:"reference button with absolute position",render:t=>e.jsxs("div",{style:{maxHeight:"80vh",overflowY:"auto"},children:[e.jsx(a,{...t}),e.jsx(a,{...t}),e.jsx(a,{...t}),e.jsx(a,{...t}),e.jsx(a,{...t}),e.jsx(a,{...t})]})},m={name:"programatically handle",render:t=>{const r=s.useRef(null);return s.useEffect(()=>{r.current?.open()},[]),e.jsxs(e.Fragment,{children:[e.jsx(l,{variant:"link",type:"button",onClick:()=>r.current?.open(),children:"open"}),e.jsxs(o,{...t,ref:r,label:e.jsx("span",{children:"show"}),children:[e.jsx("p",{children:"hello world!"}),e.jsx(l,{variant:"link",type:"button",onClick:()=>r.current?.close(),children:"close me!"})]})]})}},x={name:"clickable parent",render:t=>{const[r,n]=s.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsxs("button",{className:"hover:underline",onClick:()=>n(!r),children:[e.jsx("span",{children:"parent button contents"}),e.jsx("br",{}),e.jsx(o,{...t,label:i,children:e.jsx("p",{children:"hello world"})})]}),r?e.jsx("div",{children:"oh no! your parent click event is triggered!"}):null]})}},v={name:"popover with tooltip",render:t=>e.jsx(o,{...t,label:i,children:e.jsx(f,{label:"tooltip!",children:e.jsx("p",{children:"hello world"})})})},g={name:"popover close manually",render:t=>{const r=s.useRef(null);return e.jsxs(o,{ref:r,...t,label:i,onManualClose:k,children:[e.jsx("p",{children:"hello world"}),e.jsx(l,{type:"button",onClick:()=>r.current?.close(),children:"close!"})]})}},b={name:"auto width",render:t=>{const[r,n]=s.useState(100);return e.jsx(o,{...t,label:e.jsx(l,{variant:"outline",style:{width:"250px"},children:"click me"}),onOpen:c=>{c&&n(c.getBoundingClientRect().width)},children:e.jsx("p",{style:{width:r},children:"hello world"})})}};function a(t){const[r,n]=s.useState(!1);return e.jsx("div",{onPointerOver:()=>n(!0),onPointerLeave:()=>n(!1),style:{position:"relative",width:"40vw",height:"20vh",background:"#eee",marginBottom:3},children:r&&e.jsx("div",{style:{position:"absolute",right:4,top:0,transform:"translateY(100%)",zIndex:10},children:e.jsx(o,{...t,label:e.jsx(l,{variant:"ghost",type:"button",children:"button!"}),children:"hello world!"})})})}p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
