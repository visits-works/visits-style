...
var stripedStyle = (0, _styledComponents.css)(["tbody > tr:nth-child(odd){background-color:rgba(0,0,0,0.02);}"]);
var hoverStyle = (0, _styledComponents.css)(["tbody > tr:hover{background-color:rgba(0,0,0,0.04);}"]);
...
var Table = _styledComponents.default.table.withConfig({
  ...
  return headerStyle ? (0, _styledComponents.css)(["th{", "}"], headerStyle) : '';
});
