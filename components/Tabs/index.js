...
function (_Component) {
  ...
  function Tabs() {
    ...
    _this.renderChildren = function (child, index) {
      ...
      return _react.default.createElement(TabItem, Object.assign({}, child.props, {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(Wrapper, {
        align: align
      }, start > maxItems && _react.default.createElement(_Button.default, {
        color: "text"
      }, '<'), _react.default.createElement("div", {
        className: "tab-content"
      }, _react.Children.map(children, this.renderChildren), _react.default.createElement(Indicator, {
        color: color,
        style: style
      })), total > maxItems && start > maxItems && _react.default.createElement(_Button.default, {
        color: "text"
      }, '>'));
    }
  }], [{
